...
class optional:
    ...
    (But if the optional portion exists, it must validate.)  E.g.:
...
class json_validator_wrapper:
    ...
    def required_keys(self):
        ...
        my_keys = self.json_structure.keys() if isinstance(self, required) else []
...
def json_validate(json_structure):
    ...
    Then the following client input would validate successfully:
